<%-- 
    ...
    Created on : 28 Sept 2025, 11:46:50
    Author     : FPT
--%>
...
<head>
    ...
    <body class="product-details">
		...
		<!-- header-area-start -->
                <jsp:include page="../common/product-detail-common/header-area.jsp"></jsp:include>
		<!-- header-area-end -->
		<!-- breadcrumbs-area-start -->
                <jsp:include page="../common/product-detail-common/breadcrumbs-area.jsp"></jsp:include>
		...
		<!-- product-main-area-end -->
		<!-- footer-area-start -->
                <jsp:include page="../common/product-detail-common/footer-area.jsp"></jsp:include>
		<!-- footer-area-end -->
		<!-- Modal -->
