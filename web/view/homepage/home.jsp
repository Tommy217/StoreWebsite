<%-- 
    Document   : home
    Created on : 27 Sept 2025, 16:02:12
    Author     : FPT
--%>
...
<!--	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/font-awesome.min.css">-->
    ...
    <body class="shop">
        ...
        <header>
            ...
            <jsp:include page="../common/home-common/header-top-area.jsp"></jsp:include>
                <!-- header-top-area-end -->
                <!-- header-mid-area-start -->
            <jsp:include page="../common/home-common/header-mid-area.jsp"></jsp:include>
                <!-- header-mid-area-end -->
                <!-- main-menu-area-start -->
            <jsp:include page="../common/home-common/main-menu-area.jsp"></jsp:include>
                <!-- main-menu-area-end -->
                <!-- mobile-menu-area-start -->
            <jsp:include page="../common/home-common/mobile-menu-area.jsp"></jsp:include>
                <!-- mobile-menu-area-end -->
            </header>
            <!-- header-area-end -->
            <!-- breadcrumbs-area-start -->
        <jsp:include page="../common/home-common/breadcrumbs-area.jsp"></jsp:include>
        ...
        <!-- shop-main-area-end -->
        <!-- footer-area-start -->
        <jsp:include page="../common/home-common/footer-area.jsp"></jsp:include>
            <!-- footer-area-end -->
            <!-- Modal -->
